...
class GameField(object):
    ...
    def move(self, direction):
        # 一行向左合并
        # 向上下右合并通过矩阵转置与矩阵逆转操作节省代码量，减少重复劳动。
    ...
    # 随机生成一个 2 或者 4
    def spawn(self):
        # randrange()函数，返回指定递增基数（100）集合中的一个随机数
        # 如果这个随机数大于 89，new_element 等于 4，否则等于 2
    ...
    def move_is_possible(self, direction):
        ...
        def row_is_left_movable(row):
            ...
            # 如果全部为False，则返回 False，如果有一个为 True，则返回 True。
